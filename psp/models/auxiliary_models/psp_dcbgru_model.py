...
def build_model(params):
    """
    Description:
        Building PSP-DCBGRU neural network model. 3x1DConv convolutional layers
        followed by 2 bidirectional GRU recurrent layers and 3 fully-connected layers.
    Args:
