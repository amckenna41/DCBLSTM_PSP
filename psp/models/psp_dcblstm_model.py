...
def build_model(params):
    """
    Description:
        Building DCBLSTM neural network model.
    Args:
    ...
    lstm_f1 = Bidirectional(LSTM(params["model_parameters"][0]["lstm_layer1_units"],return_sequences=True,
    ...
    lstm_f2 = Bidirectional(LSTM(params["model_parameters"][0]["lstm_layer2_units"],return_sequences=True,
        activation = params["model_parameters"][0]["lstm_layer_activation"], recurrent_activation=params["model_parameters"][0]["lstm_recurrent_activation"],
    ...
    concat_features = Concatenate(axis=-1)([lstm_f1, lstm_f2, conv3_dropout])
