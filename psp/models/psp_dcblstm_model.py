...
def build_model(params):
    """
    Description:
        Building PSP-DCBLSTM neural network model. 3x1DConv convolutional layers
        followed by 2 bidirectional LSTM recurrent layers and 3 fully-connected layers.
    Args:
