#Creating LSTM model using just the protein sequence profiles as input
...
def main(args):
    ...
    print('Saving model')
    save_path = 'model_lstm_seq' + str(datetime.date(datetime.now())) + '.h5'
