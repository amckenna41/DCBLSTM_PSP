...
gcloud ai-platform jobs submit training JOB60 --package-path psp_gcp/training --module-name training.psp_lstm_gcp --staging-bucket gs://keras-python-models --region us-central1 --config psp_gcp/training/temp_gcp_configfile.yaml --runtime-version 2.1 --python-version 3.7  --job-dir gs://keras-python-models
