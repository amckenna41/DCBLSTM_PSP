...
parser.add_argument('-conv2d_dropout', '--conv2d_dropout',
                    help='dropout',required=False, default = 0.5)
...
parser.add_argument('-dense_1', '--dense_1',
                    help='dense_dropout',required=False, default = 128)
parser.add_argument('-dense_2', '--dense_2',
                    help='dense_dropout',required=False, default = 64)
parser.add_argument('-dense_3', '--dense_3',
                    help='dense_dropout',required=False, default = 32)
